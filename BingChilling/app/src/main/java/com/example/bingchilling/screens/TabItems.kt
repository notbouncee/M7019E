...
sealed class TabItem(val title: String,
    ...
    object Home : TabItem("Home", Icons.Default.Home, { navController, viewModel, db, isConnected ->
        TheMovieDBApp(viewModel = viewModel)
    })

    data object Favourites : TabItem("Favourites", Icons.Default.Favorite, { navController, viewModel, db, isConnected ->
        FavoriteMoviesTab(
